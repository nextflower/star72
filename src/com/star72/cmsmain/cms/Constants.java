package com.star72.cmsmain.cms;
...
public class Constants {
	 ...
	 * 数据库备份文本前缀
	 */
	public static String ONESQL_PREFIX="star72_BACKUP_";
	/**
	 * 防火墙配置文件
	 */
	 ...
	 * 配置文件
	 */
	public static String star72_CONFIG = "/WEB-INF/config/star72/star72.properties";
	/**
	 * 插件路径
	 */
	 ...
	 * 模板路径
	 */
	public static final String TPL_BACK_BASE = "/WEB-INF/star72_sys";
}
