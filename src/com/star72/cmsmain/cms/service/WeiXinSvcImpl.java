...
import com.star72.cmsmain.common.upload.FileUpload;
import com.star72.cmsmain.common.util.PropertyUtils;
...
public class WeiXinSvcImpl implements WeiXinSvc {
	...
	public String getToken() {
		String tokenGetUrl=PropertyUtils.getPropertyValue(new File(realPathResolver.get(Constants.star72_CONFIG)),TOKEN_KEY);
	...
	public Set<String> getUsers(String access_token) {
		String usersGetUrl=PropertyUtils.getPropertyValue(new File(realPathResolver.get(Constants.star72_CONFIG)),USERS_KEY);
	...
	public String  uploadFile(String access_token,String filePath,String type){
		String sendGetUrl=PropertyUtils.getPropertyValue(new File(realPathResolver.get(Constants.star72_CONFIG)),UPLOAD_KEY);
	...
	public void sendText(String access_token,String content) {
		String sendGetUrl=PropertyUtils.getPropertyValue(new File(realPathResolver.get(Constants.star72_CONFIG)),SEND_KEY);
        String url = sendGetUrl+"?access_token=" + access_token;
	...
	public void sendContent(String access_token,String title, String description, String url,
			String picurl) {
		String sendUrl=PropertyUtils.getPropertyValue(new File(realPathResolver.get(Constants.star72_CONFIG)),SEND_KEY);
