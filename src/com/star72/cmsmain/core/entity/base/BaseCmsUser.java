package com.star72.cmsmain.core.entity.base;
...
public abstract class BaseCmsUser  implements Serializable {
	...
	public BaseCmsUser (
		...
		com.star72.cmsmain.core.entity.CmsGroup group,
	...
	// many to one
	private com.star72.cmsmain.core.entity.CmsGroup group;

	// collections
	private java.util.Map<java.lang.String, java.lang.String> attr;
	private java.util.Set<com.star72.cmsmain.core.entity.CmsUserExt> userExtSet;
	private java.util.Set<com.star72.cmsmain.core.entity.CmsUserSite> userSites;
	private java.util.Set<com.star72.cmsmain.core.entity.CmsRole> roles;
	private java.util.Set<com.star72.cmsmain.cms.entity.main.Channel> channels;
	private java.util.Set<com.star72.cmsmain.cms.entity.main.Content> collectContents;
	
	private java.util.Set<com.star72.cmsmain.cms.entity.assist.CmsMessage> sendMessages;
	private java.util.Set<com.star72.cmsmain.cms.entity.assist.CmsMessage> receivMessages;
	private java.util.Set<com.star72.cmsmain.cms.entity.assist.CmsReceiverMessage> sendReceiverMessages;
	private java.util.Set<com.star72.cmsmain.cms.entity.assist.CmsReceiverMessage> receivReceiverMessages;
	
	private java.util.Set<com.star72.cmsmain.cms.entity.assist.CmsJobApply> jobApplys;
	private java.util.Set<com.star72.cmsmain.core.entity.CmsUserResume> userResumeSet;
	private java.util.Set<CmsLog> logs;
	private java.util.Set<com.star72.cmsmain.cms.entity.assist.CmsUserMenu> menus;
	 ...
	 */
	public com.star72.cmsmain.core.entity.CmsGroup getGroup () {
		return group;
	}
	 ...
	 */
	public void setGroup (com.star72.cmsmain.core.entity.CmsGroup group) {
		this.group = group;
	}
	 ...
	 */
	public java.util.Set<com.star72.cmsmain.core.entity.CmsUserExt> getUserExtSet () {
		return userExtSet;
	}
	 ...
	 */
	public void setUserExtSet (java.util.Set<com.star72.cmsmain.core.entity.CmsUserExt> userExtSet) {
	 ...
	 */
	public java.util.Set<com.star72.cmsmain.core.entity.CmsUserSite> getUserSites () {
		return userSites;
	}
	 ...
	 */
	public void setUserSites (java.util.Set<com.star72.cmsmain.core.entity.CmsUserSite> userSites) {
	 ...
	 */
	public java.util.Set<com.star72.cmsmain.core.entity.CmsRole> getRoles () {
		return roles;
	}
	 ...
	 */
	public void setRoles (java.util.Set<com.star72.cmsmain.core.entity.CmsRole> roles) {
		this.roles = roles;
	}
	...
	public java.util.Set<com.star72.cmsmain.cms.entity.main.Content> getCollectContents() {
		return collectContents;
	}

	public void setCollectContents(
			java.util.Set<com.star72.cmsmain.cms.entity.main.Content> collectContents) {
		this.collectContents = collectContents;
	}
	
	public java.util.Set<com.star72.cmsmain.cms.entity.assist.CmsMessage> getSendMessages() {
		return sendMessages;
	}

	public void setSendMessages(
			java.util.Set<com.star72.cmsmain.cms.entity.assist.CmsMessage> sendMessages) {
		this.sendMessages = sendMessages;
	}

	public java.util.Set<com.star72.cmsmain.cms.entity.assist.CmsMessage> getReceivMessages() {
		return receivMessages;
	}

	public void setReceivMessages(
			java.util.Set<com.star72.cmsmain.cms.entity.assist.CmsMessage> receivMessages) {
		this.receivMessages = receivMessages;
	}

	public java.util.Set<com.star72.cmsmain.cms.entity.assist.CmsReceiverMessage> getSendReceiverMessages() {
		return sendReceiverMessages;
	}

	public void setSendReceiverMessages(
			java.util.Set<com.star72.cmsmain.cms.entity.assist.CmsReceiverMessage> sendReceiverMessages) {
		this.sendReceiverMessages = sendReceiverMessages;
	}

	public java.util.Set<com.star72.cmsmain.cms.entity.assist.CmsReceiverMessage> getReceivReceiverMessages() {
		return receivReceiverMessages;
	}

	public void setReceivReceiverMessages(
			java.util.Set<com.star72.cmsmain.cms.entity.assist.CmsReceiverMessage> receivReceiverMessages) {
	...
	public java.util.Set<com.star72.cmsmain.core.entity.CmsUserResume> getUserResumeSet() {
			return userResumeSet;
		}
	
	public void setUserResumeSet(
				java.util.Set<com.star72.cmsmain.core.entity.CmsUserResume> userResumeSet) {
	...
	public java.util.Set<com.star72.cmsmain.cms.entity.assist.CmsUserMenu> getMenus() {
		return menus;
	}

	public void setMenus(
			java.util.Set<com.star72.cmsmain.cms.entity.assist.CmsUserMenu> menus) {
		this.menus = menus;
	}

	public boolean equals (Object obj) {
		if (null == obj) return false;
		if (!(obj instanceof com.star72.cmsmain.core.entity.CmsUser)) return false;
		else {
			com.star72.cmsmain.core.entity.CmsUser cmsUser = (com.star72.cmsmain.core.entity.CmsUser) obj;
