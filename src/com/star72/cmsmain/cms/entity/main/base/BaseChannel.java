...
public abstract class BaseChannel  implements Serializable {
	...
	public BaseChannel (
		...
		com.star72.cmsmain.cms.entity.main.CmsModel model,
	...
	// one to one
	private com.star72.cmsmain.cms.entity.main.ChannelExt channelExt;
	private com.star72.cmsmain.cms.entity.main.ChannelCount channelCount;

	// many to one
	private com.star72.cmsmain.core.entity.CmsSite site;
	private com.star72.cmsmain.cms.entity.main.CmsModel model;
	private com.star72.cmsmain.cms.entity.main.Channel parent;

	// collections
	private java.util.Set<com.star72.cmsmain.cms.entity.main.Channel> child;
	private java.util.Set<com.star72.cmsmain.core.entity.CmsGroup> viewGroups;
	private java.util.Set<com.star72.cmsmain.core.entity.CmsGroup> contriGroups;
	private java.util.Set<com.star72.cmsmain.core.entity.CmsUser> users;
	private java.util.Set<com.star72.cmsmain.cms.entity.main.ChannelTxt> channelTxtSet;
	private java.util.List<com.star72.cmsmain.cms.entity.main.ChannelModel> channelModels;
	 ...
	 */
	public com.star72.cmsmain.cms.entity.main.ChannelExt getChannelExt () {
		return channelExt;
	}
	 ...
	 */
	public void setChannelExt (com.star72.cmsmain.cms.entity.main.ChannelExt channelExt) {
		this.channelExt = channelExt;
	}
	
	public com.star72.cmsmain.cms.entity.main.ChannelCount getChannelCount() {
		return channelCount;
	}

	public void setChannelCount(com.star72.cmsmain.cms.entity.main.ChannelCount channelCount) {
	 ...
	 */
	public com.star72.cmsmain.cms.entity.main.Channel getParent () {
		return parent;
	}
	 ...
	 */
	public void setParent (com.star72.cmsmain.cms.entity.main.Channel parent) {
		this.parent = parent;
	}
	 ...
	 */
	public java.util.Set<com.star72.cmsmain.cms.entity.main.Channel> getChild () {
		return child;
	}
	 ...
	 */
	public void setChild (java.util.Set<com.star72.cmsmain.cms.entity.main.Channel> child) {
		this.child = child;
	}
	 ...
	 */
	public java.util.Set<com.star72.cmsmain.core.entity.CmsGroup> getContriGroups () {
		return contriGroups;
	}
	 ...
	 */
	public void setContriGroups (java.util.Set<com.star72.cmsmain.core.entity.CmsGroup> contriGroups) {
	 ...
	 */
	public java.util.Set<com.star72.cmsmain.core.entity.CmsUser> getUsers () {
		return users;
	}
	 ...
	 */
	public void setUsers (java.util.Set<com.star72.cmsmain.core.entity.CmsUser> users) {
		this.users = users;
	}
	/**
	 * Return the value associated with the column: channelTxtSet
	 */
	public java.util.Set<com.star72.cmsmain.cms.entity.main.ChannelTxt> getChannelTxtSet () {
	 ...
	 */
	public void setChannelTxtSet (java.util.Set<com.star72.cmsmain.cms.entity.main.ChannelTxt> channelTxtSet) {
		this.channelTxtSet = channelTxtSet;
	}

	public java.util.List<com.star72.cmsmain.cms.entity.main.ChannelModel> getChannelModels() {
		return channelModels;
	}

	public void setChannelModels(
			java.util.List<com.star72.cmsmain.cms.entity.main.ChannelModel> channelModels) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.star72.cmsmain.cms.entity.main.Channel)) return false;
		else {
			com.star72.cmsmain.cms.entity.main.Channel channel = (com.star72.cmsmain.cms.entity.main.Channel) obj;
